...
////////////////////////////////////////////
 ...
 dz:=0.2;
 q:=1/t2;
     tau:=0.4426; {0.3; 0.54;} //важно для запаздывания
  ...
  y:=z3;   //3 звено
  k1:=(k30/t3*y2-y/t3)*dt;
  k2:=(k30/t3*y2-(y+k1/2)/t3)*dt;
  k3:=(k30/t3*y2-(y+k2/2)/t3)*dt;
  k4:=(k30/t3*y2-(y+k3)/t3)*dt;
  ...
  Series1.AddXY(std,y3);  //график без запаздывания
